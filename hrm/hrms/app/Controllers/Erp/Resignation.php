	...
	public function add_resignation() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$notice_date = $this->request->getPost('notice_date',FILTER_DEFAULT);
				$resignation_date = $this->request->getPost('resignation_date',FILTER_DEFAULT);
	...
	public function update_resignation() {
		...
		if ($this->request->getPost('type',FILTER_DEFAULT) === 'edit_record') {
			...
			if(!$this->validate($rules)){
				...
				$notice_date = $this->request->getPost('notice_date',FILTER_DEFAULT);
				$resignation_date = $this->request->getPost('resignation_date',FILTER_DEFAULT);
				$reason = $request->getPost('reason',FILTER_DEFAULT);		
