	...
	public function add_visitor() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$visitor_name = $this->request->getPost('visitor_name',FILTER_DEFAULT);
				$visit_date = $this->request->getPost('visit_date',FILTER_DEFAULT);
				$check_in = $this->request->getPost('check_in',FILTER_DEFAULT);
				$phone = $this->request->getPost('phone',FILTER_DEFAULT);
				$email = $this->request->getPost('email',FILTER_DEFAULT);
				$address = $this->request->getPost('address',FILTER_DEFAULT);
	...
	public function update_visitor() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			if(!$this->validate($rules)){
				...
				$visit_date = $this->request->getPost('visit_date',FILTER_DEFAULT);
				$check_in = $this->request->getPost('check_in',FILTER_DEFAULT);
				$check_out = $this->request->getPost('check_out',FILTER_DEFAULT);
				$phone = $this->request->getPost('phone',FILTER_DEFAULT);
				$email = $this->request->getPost('email',FILTER_DEFAULT);
				$address = $this->request->getPost('address',FILTER_DEFAULT);
				$description = $this->request->getPost('description',FILTER_DEFAULT);
