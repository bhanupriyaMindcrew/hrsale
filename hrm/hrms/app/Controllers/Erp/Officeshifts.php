	...
	public function add_office_shift() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$shift_name = $this->request->getPost('shift_name',FILTER_DEFAULT);
				$monday_in_time = $this->request->getPost('monday_in_time',FILTER_DEFAULT);
				$monday_out_time = $this->request->getPost('monday_out_time',FILTER_DEFAULT);
				$tuesday_in_time = $this->request->getPost('tuesday_in_time',FILTER_DEFAULT);
				$tuesday_out_time = $this->request->getPost('tuesday_out_time',FILTER_DEFAULT);
				$wednesday_in_time = $this->request->getPost('wednesday_in_time',FILTER_DEFAULT);
				$wednesday_out_time = $this->request->getPost('wednesday_out_time',FILTER_DEFAULT);
				$thursday_in_time = $this->request->getPost('thursday_in_time',FILTER_DEFAULT);
				$thursday_out_time = $this->request->getPost('thursday_out_time',FILTER_DEFAULT);
				$friday_in_time = $this->request->getPost('friday_in_time',FILTER_DEFAULT);
				$friday_out_time = $this->request->getPost('friday_out_time',FILTER_DEFAULT);
				$saturday_in_time = $this->request->getPost('saturday_in_time',FILTER_DEFAULT);
				$saturday_out_time = $this->request->getPost('saturday_out_time',FILTER_DEFAULT);
				$sunday_in_time = $this->request->getPost('sunday_in_time',FILTER_DEFAULT);
				$sunday_out_time = $this->request->getPost('sunday_out_time',FILTER_DEFAULT);
