	...
	public function add_customfield() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$module = $this->request->getPost('module',FILTER_DEFAULT);
				$name = $this->request->getPost('name',FILTER_DEFAULT);
				$field_label = $this->request->getPost('field_label',FILTER_DEFAULT);
				$priority = $this->request->getPost('priority',FILTER_DEFAULT);
				$validation = $this->request->getPost('validation',FILTER_DEFAULT);
				$field_type = $this->request->getPost('field_type',FILTER_DEFAULT);
				$column = $this->request->getPost('column',FILTER_DEFAULT);
