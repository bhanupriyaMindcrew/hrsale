	...
	public function add_transfer() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$staff_id = $this->request->getPost('employee',FILTER_DEFAULT);
				$department = $this->request->getPost('department',FILTER_DEFAULT);
				$designation = $this->request->getPost('designation',FILTER_DEFAULT);
				$transfer_date = $this->request->getPost('transfer_date',FILTER_DEFAULT);
