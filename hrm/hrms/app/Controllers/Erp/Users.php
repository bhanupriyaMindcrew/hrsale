...
class Users extends BaseController {
	...
	public function add_role() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			$role_name = $this->request->getPost('role_name',FILTER_DEFAULT);
			$role_access = $this->request->getPost('role_access',FILTER_DEFAULT);
			$role_resources_field = $this->request->getPost('role_resources',FILTER_DEFAULT);
	...
	public function update_role() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			$role_access = $this->request->getPost('role_access',FILTER_DEFAULT);
			$id = udecode($this->request->getPost('token',FILTER_DEFAULT));
			$role_resources = implode(',',$this->request->getPost('role_resources',FILTER_DEFAULT));
			$data = [
				'role_name' => $role_name,
				'role_access'  => $role_access,
				'role_resources'  => $role_resources
