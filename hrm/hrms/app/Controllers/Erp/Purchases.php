	...
	public function create_new_purchase() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$purchase_number = $this->request->getPost('purchase_number',FILTER_DEFAULT);
				$supplier = $this->request->getPost('supplier',FILTER_DEFAULT);
				$purchase_date = $this->request->getPost('purchase_date',FILTER_DEFAULT);
				...
				$purchase_note = $this->request->getPost('purchase_note',FILTER_DEFAULT);
