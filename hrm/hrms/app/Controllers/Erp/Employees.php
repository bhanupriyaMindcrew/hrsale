...
class Employees extends BaseController {
	...
	public function employees_list() {
		...
		$data = array();
          ...
          foreach($staff as $r) {						
			...
			$country='';
            if(isset($country_info['country_name']) && !empty($country_info['country_name'])){
	...
	public function add_employee() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			$office_shift_id = $this->request->getPost('office_shift_id',FILTER_DEFAULT);
			$department_id = $this->request->getPost('department_id',FILTER_DEFAULT);
			$designation_id = $this->request->getPost('designation_id',FILTER_DEFAULT);
			$basic_salary = $this->request->getPost('basic_salary',FILTER_DEFAULT);
			$hourly_rate = $this->request->getPost('hourly_rate',FILTER_DEFAULT);
			$salay_type = $this->request->getPost('salay_type',FILTER_DEFAULT);
	...
	public function add_allowance() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$contract_tax_option = $this->request->getPost('contract_tax_option',FILTER_DEFAULT);
				$is_fixed = $this->request->getPost('is_fixed',FILTER_DEFAULT);
				$option_title = $this->request->getPost('option_title',FILTER_DEFAULT);	
				$contract_amount = $this->request->getPost('contract_amount',FILTER_DEFAULT);
	...
	public function add_document() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$document_name = $this->request->getPost('document_name',FILTER_DEFAULT);
				$document_type = $this->request->getPost('document_type',FILTER_DEFAULT);
				$id = udecode($this->request->getPost('token',FILTER_DEFAULT));
	...
	public function update_basic_info() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			$status = $this->request->getPost('status',FILTER_DEFAULT);
	...
	public function update_company_info() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			$address_1 = $this->request->getPost('address_1',FILTER_DEFAULT);
			$address_2 = $this->request->getPost('address_2',FILTER_DEFAULT);
			$country_id = $this->request->getPost('country',FILTER_DEFAULT);
			
			// staff details
			$cat_ids = implode(',',$this->request->getPost('leave_categories',FILTER_DEFAULT));
			$employee_id = $this->request->getPost('employee_id',FILTER_DEFAULT);
			$office_shift_id = $this->request->getPost('office_shift_id',FILTER_DEFAULT);
			$department_id = $this->request->getPost('department_id',FILTER_DEFAULT);
			$designation_id = $this->request->getPost('designation_id',FILTER_DEFAULT);
			$date_of_joining = $this->request->getPost('date_of_joining',FILTER_DEFAULT);
			$date_of_leaving = $this->request->getPost('date_of_leaving',FILTER_DEFAULT);
			$date_of_birth = $this->request->getPost('date_of_birth',FILTER_DEFAULT);
			$marital_status = $this->request->getPost('marital_status',FILTER_DEFAULT);
			$religion = $this->request->getPost('religion',FILTER_DEFAULT);
			$blood_group = $this->request->getPost('blood_group',FILTER_DEFAULT);
	...
	public function update_contract_info() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			//staff details
			$date_of_joining = $this->request->getPost('contract_date',FILTER_DEFAULT);
			$department_id = $this->request->getPost('department_id',FILTER_DEFAULT);
			$designation_id = $this->request->getPost('designation_id',FILTER_DEFAULT);
			$basic_salary = $this->request->getPost('basic_salary',FILTER_DEFAULT);
			$hourly_rate = $this->request->getPost('hourly_rate',FILTER_DEFAULT);
			$salay_type = $this->request->getPost('salay_type',FILTER_DEFAULT);
			$office_shift_id = $this->request->getPost('office_shift_id',FILTER_DEFAULT);
			$role_description = $this->request->getPost('role_description',FILTER_DEFAULT);
			$date_of_leaving = $this->request->getPost('contract_end',FILTER_DEFAULT);
	...
	public function delete_all_allowances() {
		...
		$session = \Config\Services::session();
			...
			$id = udecode($this->request->getPost('_token',FILTER_DEFAULT));
			$Return['csrf_hash'] = csrf_hash();
			$ContractModel = new ContractModel();
