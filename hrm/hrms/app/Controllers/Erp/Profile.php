...
class Profile extends BaseController {
	...
	public function update_profile() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			$first_name = $this->request->getPost('first_name',FILTER_DEFAULT);
			$last_name = $this->request->getPost('last_name',FILTER_DEFAULT);
			$email = $this->request->getPost('email',FILTER_DEFAULT);
			$username = $this->request->getPost('username',FILTER_DEFAULT);
			$contact_number = $this->request->getPost('contact_number',FILTER_DEFAULT);
			$country = $this->request->getPost('country',FILTER_DEFAULT);
			$gender = $this->request->getPost('gender',FILTER_DEFAULT);
			$address_1 = $this->request->getPost('address_1',FILTER_DEFAULT);
			$address_2 = $this->request->getPost('address_2',FILTER_DEFAULT);
			$city = $this->request->getPost('city',FILTER_DEFAULT);
			$state = $this->request->getPost('state',FILTER_DEFAULT);
			$zipcode = $this->request->getPost('zipcode',FILTER_DEFAULT);
	...
	public function update_password() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			$user_info = $UsersModel->where('user_id', $usession['sup_user_id'])->first();
			//check error
			$new_password = $this->request->getPost('new_password',FILTER_DEFAULT);
	...
	public function update_company_info() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			$company_name = $this->request->getPost('company_name',FILTER_DEFAULT);
			$company_type = $this->request->getPost('company_type',FILTER_DEFAULT);
			$trading_name = $this->request->getPost('trading_name',FILTER_DEFAULT);
			$registration_no = $this->request->getPost('registration_no',FILTER_DEFAULT);
			$xin_gtax = $this->request->getPost('xin_gtax',FILTER_DEFAULT);
	...
	public function update_basic_info() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			// staff details
			$date_of_birth = $this->request->getPost('date_of_birth',FILTER_DEFAULT);
			$marital_status = $this->request->getPost('marital_status',FILTER_DEFAULT);
			$religion = $this->request->getPost('religion',FILTER_DEFAULT);
			$blood_group = $this->request->getPost('blood_group',FILTER_DEFAULT);
			$citizenship_id = $this->request->getPost('citizenship_id',FILTER_DEFAULT);
			$employee_id = $this->request->getPost('employee_id',FILTER_DEFAULT);
	...
	public function update_bio() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			$Return['csrf_hash'] = csrf_hash();
			//staff details
			$bio = $this->request->getPost('bio',FILTER_DEFAULT);
			$experience = $this->request->getPost('experience',FILTER_DEFAULT);
			// set rules
			$validation->setRules([
					'bio' => 'required'
				],
	...
	public function update_social() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			$Return['csrf_hash'] = csrf_hash();
			//staff details
			$fb_profile = $this->request->getPost('fb_profile',FILTER_DEFAULT);
			$twitter_profile = $this->request->getPost('twitter_profile',FILTER_DEFAULT);
			$gplus_profile = $this->request->getPost('gplus_profile',FILTER_DEFAULT);
			$linkedin_profile = $this->request->getPost('linkedin_profile',FILTER_DEFAULT);
	...
	public function update_bankinfo() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			$Return['csrf_hash'] = csrf_hash();
			//staff details
			$account_title = $this->request->getPost('account_title',FILTER_DEFAULT);
			$account_number = $this->request->getPost('account_number',FILTER_DEFAULT);
			$bank_name = $this->request->getPost('bank_name',FILTER_DEFAULT);
			$iban = $this->request->getPost('iban',FILTER_DEFAULT);
			$swift_code = $this->request->getPost('swift_code',FILTER_DEFAULT);
			$bank_branch = $this->request->getPost('bank_branch',FILTER_DEFAULT);
	...
	public function update_contact_info() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			$Return['csrf_hash'] = csrf_hash();
			//staff details
			$contact_full_name = $this->request->getPost('contact_full_name',FILTER_DEFAULT);
			$contact_phone_no = $this->request->getPost('contact_phone_no',FILTER_DEFAULT);
			$contact_email = $this->request->getPost('contact_email',FILTER_DEFAULT);
			$contact_address = $this->request->getPost('contact_address',FILTER_DEFAULT);
			// set rules
			$validation->setRules([
	...
	public function system_info() {
		...
		$default_currency = $this->request->getPost('default_currency',FILTER_DEFAULT);
		$default_currency_symbol = $this->request->getPost('default_currency',FILTER_DEFAULT);
		$date_format = $this->request->getPost('date_format',FILTER_DEFAULT);
		$system_timezone = $this->request->getPost('system_timezone',FILTER_DEFAULT);
		$default_language = $this->request->getPost('default_language',FILTER_DEFAULT);	
		$invoice_terms_condition = $this->request->getPost('invoice_terms_condition',FILTER_DEFAULT);
		
		$id = udecode($this->request->getPost('token',FILTER_DEFAULT));
		$data = [
	...
	public function update_payment_gateway() {
		...
		$paypal_email = $this->request->getPost('paypal_email',FILTER_DEFAULT);
		$paypal_sandbox = $this->request->getPost('paypal_sandbox',FILTER_DEFAULT);
		$paypal_active = $this->request->getPost('paypal_active',FILTER_DEFAULT);
		$stripe_secret_key = $this->request->getPost('stripe_secret_key',FILTER_DEFAULT);
		$stripe_publishable_key = $this->request->getPost('stripe_publishable_key',FILTER_DEFAULT);
		$stripe_active = $this->request->getPost('stripe_active',FILTER_DEFAULT);
		$id = udecode($this->request->getPost('token',FILTER_DEFAULT));
		$data = [
	...
	public function notification_position_info() {
		...
		$notification_position = $this->request->getPost('notification_position',FILTER_DEFAULT);
		$notification_close = $this->request->getPost('notification_close',FILTER_DEFAULT);
		$notification_bar = $this->request->getPost('notification_bar',FILTER_DEFAULT);
	...
	public function setup_modules_info() {
		...
		if ($this->request->getPost('type') === 'setup_modules_info') {
			...
			$setup_modules = $this->request->getPost('setup_module',FILTER_DEFAULT);
	...
	public function layout_info() {
		...
		if ($this->request->getPost('type') === 'layout_info') {
			...
			$header_background = $this->request->getPost('header_background',FILTER_DEFAULT);
			$calendar_locale = $this->request->getPost('calendar_locale',FILTER_DEFAULT);
			$datepicker_locale = $this->request->getPost('datepicker_locale',FILTER_DEFAULT);
			$login_page = $this->request->getPost('login_page',FILTER_DEFAULT);
			$login_page_text = $this->request->getPost('login_page_text',FILTER_DEFAULT);
			$id = udecode($this->request->getPost('token',FILTER_DEFAULT));
			$data = [
