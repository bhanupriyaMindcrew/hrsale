	...
	public function add_account() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$account_name = $this->request->getPost('account_name',FILTER_DEFAULT);		
				$account_balance = $this->request->getPost('account_balance',FILTER_DEFAULT);	
				$account_number = $this->request->getPost('account_number',FILTER_DEFAULT);
				$branch_code = $this->request->getPost('branch_code',FILTER_DEFAULT);
	...
	public function add_deposit() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$account_id = $this->request->getPost('account_id',FILTER_DEFAULT);
				$amount = $this->request->getPost('amount',FILTER_DEFAULT);
				$deposit_date = $this->request->getPost('deposit_date',FILTER_DEFAULT);
				$category_id = $this->request->getPost('category_id',FILTER_DEFAULT);
				$payer_id = $this->request->getPost('payer_id',FILTER_DEFAULT);
				...
				$reference = $this->request->getPost('reference',FILTER_DEFAULT);
