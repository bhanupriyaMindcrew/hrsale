	...
	public function add_product() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$category = $this->request->getPost('category',FILTER_DEFAULT);
				$warehouse = $this->request->getPost('warehouse',FILTER_DEFAULT);
				$barcode_type = $this->request->getPost('barcode_type',FILTER_DEFAULT);
				$barcode = $this->request->getPost('barcode',FILTER_DEFAULT);
				$sku = $this->request->getPost('sku',FILTER_DEFAULT);
				$serial_number = $this->request->getPost('serial_number',FILTER_DEFAULT);
				$qty = $this->request->getPost('qty',FILTER_DEFAULT);
				$reorder_stock = $this->request->getPost('reorder_stock',FILTER_DEFAULT);
				$expiration_date = $this->request->getPost('expiration_date',FILTER_DEFAULT);
				$purchase_price = $this->request->getPost('purchase_price',FILTER_DEFAULT);
				$selling_price = $this->request->getPost('selling_price',FILTER_DEFAULT);
				$product_description = $this->request->getPost('product_description',FILTER_DEFAULT);
	...
	public function update_rating() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			if(!$this->validate($rules)){
				...
				$product_rating = $this->request->getPost('product_rating',FILTER_DEFAULT);
				$id = udecode($this->request->getPost('token',FILTER_DEFAULT));
				$data = [
