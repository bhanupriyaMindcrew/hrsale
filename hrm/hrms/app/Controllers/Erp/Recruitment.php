	...
	public function add_job() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$job_title = $this->request->getPost('job_title',FILTER_DEFAULT);
				$job_type = $this->request->getPost('job_type',FILTER_DEFAULT);
				$designation_id = $this->request->getPost('designation_id',FILTER_DEFAULT);
				$vacancy = $this->request->getPost('vacancy',FILTER_DEFAULT);
				$date_of_closing = $this->request->getPost('date_of_closing',FILTER_DEFAULT);
				$short_description = $this->request->getPost('short_description',FILTER_DEFAULT);
				$long_description = $this->request->getPost('long_description',FILTER_DEFAULT);
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			if($this->request->getPost('status') == 3){
				...
				if(!$this->validate($rules)){
					...
					$interview_date = $this->request->getPost('interview_date',FILTER_DEFAULT);
					$interview_time = $this->request->getPost('interview_time',FILTER_DEFAULT);
					$interview_place = $this->request->getPost('interview_place',FILTER_DEFAULT);
					$interviewer_id = $this->request->getPost('interviewer_id',FILTER_DEFAULT);
	...
	public function apply_job() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$cover_letter = $this->request->getPost('cover_letter',FILTER_DEFAULT);
				$id = udecode($this->request->getPost('token',FILTER_DEFAULT));
