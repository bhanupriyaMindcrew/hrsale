		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
			   ...
			   $validated = $this->validate([
				...
				$leave_type = $this->request->getPost('leave_type',FILTER_DEFAULT);
				...
				$leave_half_day = $this->request->getPost('leave_half_day',FILTER_DEFAULT);
				$remarks = $this->request->getPost('remarks',FILTER_DEFAULT);
				$luser_id = $this->request->getPost('employee_id',FILTER_DEFAULT);
				$UsersModel = new UsersModel();
				$ConstantsModel = new ConstantsModel();
	...
	public function update_leave_status() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			if(!$this->validate($rules)){
				...
				$id = udecode($this->request->getPost('token_status',FILTER_DEFAULT));	
				$data = [
					'remarks' => $remarks,
					'status'  => $status
				];
