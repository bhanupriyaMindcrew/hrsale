	...
	public function add_exit() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$exit_date = $this->request->getPost('exit_date',FILTER_DEFAULT);
				$exit_type = $this->request->getPost('exit_type',FILTER_DEFAULT);
				$exit_interview = $this->request->getPost('exit_interview',FILTER_DEFAULT);
				$is_inactivate_account = $this->request->getPost('is_inactivate_account',FILTER_DEFAULT);
