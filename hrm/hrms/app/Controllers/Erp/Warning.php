	...
	public function add_warning() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$warning_type = $this->request->getPost('warning_type',FILTER_DEFAULT);
				$subject = $this->request->getPost('subject',FILTER_DEFAULT);
				$warning_date = $this->request->getPost('warning_date',FILTER_DEFAULT);
				$description = $this->request->getPost('description',FILTER_DEFAULT);
				$warning_to = $this->request->getPost('warning_to',FILTER_DEFAULT);
