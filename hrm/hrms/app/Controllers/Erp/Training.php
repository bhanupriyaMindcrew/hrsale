	...
	public function add_training() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$trainer = $this->request->getPost('trainer',FILTER_DEFAULT);
				$training_type = $this->request->getPost('training_type',FILTER_DEFAULT);
				$training_cost = $this->request->getPost('training_cost',FILTER_DEFAULT);
				...
				if($user_info['user_type'] == 'staff'){
					...
					$employee_ids = implode(',',$this->request->getPost('employee_id',FILTER_DEFAULT));
	...
	public function update_training_status() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			if(!$this->validate($rules)){
				...
				$performance = $this->request->getPost('performance',FILTER_DEFAULT);	
				$status = $this->request->getPost('status',FILTER_DEFAULT);
				$remarks = $this->request->getPost('remarks',FILTER_DEFAULT);
				$id = udecode($this->request->getPost('token',FILTER_DEFAULT));
				$data = [
