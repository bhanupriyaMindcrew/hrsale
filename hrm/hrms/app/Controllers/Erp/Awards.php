	...
	public function add_awards() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$award_type_id = $this->request->getPost('award_type_id',FILTER_DEFAULT);
				$award_date = $this->request->getPost('award_date',FILTER_DEFAULT);
				$gift = $this->request->getPost('gift',FILTER_DEFAULT);
				$cash = $this->request->getPost('cash',FILTER_DEFAULT);
				$month_year = $this->request->getPost('month_year',FILTER_DEFAULT);
				$description = $this->request->getPost('description',FILTER_DEFAULT);
				$award_information = $this->request->getPost('award_information',FILTER_DEFAULT);
