	...
	public function add_event() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$event_title = $this->request->getPost('event_title',FILTER_DEFAULT);
				$event_date = $this->request->getPost('event_date',FILTER_DEFAULT);
				$event_time = $this->request->getPost('event_time',FILTER_DEFAULT);
				$event_color = $this->request->getPost('event_color',FILTER_DEFAULT);
				$event_note = $this->request->getPost('event_note',FILTER_DEFAULT);
