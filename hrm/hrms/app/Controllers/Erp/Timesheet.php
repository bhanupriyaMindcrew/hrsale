...
class Timesheet extends BaseController {
	...
	public function add_attendance() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$attendance_date = $this->request->getPost('attendance_date_m',FILTER_DEFAULT);
				$clock_in = $this->request->getPost('clock_in_m',FILTER_DEFAULT);
				$clock_out = $this->request->getPost('clock_out_m',FILTER_DEFAULT);
	...
	public function set_clocking() {
		...
		if ($this->request->getPost('type') === 'set_clocking') {
			...
			$clock_state = $this->request->getPost('clock_state',FILTER_DEFAULT);
			$latitude = $this->request->getPost('latitude',FILTER_DEFAULT);
			$longitude = $this->request->getPost('longitude',FILTER_DEFAULT);
			$time_id = $this->request->getPost('time_id',FILTER_DEFAULT);
