	...
	public function add_asset() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$asset_name = $this->request->getPost('asset_name',FILTER_DEFAULT);
				$category_id = $this->request->getPost('category_id',FILTER_DEFAULT);
				$brand_id = $this->request->getPost('brand_id',FILTER_DEFAULT);
				$company_asset_code = $this->request->getPost('company_asset_code',FILTER_DEFAULT);
				$is_working = $this->request->getPost('is_working',FILTER_DEFAULT);
				...
				$manufacturer = $this->request->getPost('manufacturer',FILTER_DEFAULT);
				$serial_number = $this->request->getPost('serial_number',FILTER_DEFAULT);
				$warranty_end_date = $this->request->getPost('warranty_end_date',FILTER_DEFAULT);
				$asset_note = $this->request->getPost('asset_note',FILTER_DEFAULT);
				...
				if($user_info['user_type'] == 'staff'){
					...
					$staff_id = $this->request->getPost('employee_id',FILTER_DEFAULT);
