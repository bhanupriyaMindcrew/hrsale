	...
	public function create_new_quote() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$quote_number = $this->request->getPost('quote_number',FILTER_DEFAULT);
				$customer = $this->request->getPost('customer',FILTER_DEFAULT);
				$quote_date = $this->request->getPost('quote_date',FILTER_DEFAULT);
				$quote_due_date = $this->request->getPost('quote_due_date',FILTER_DEFAULT);
				$j=0;
				...
				$quote_note = $this->request->getPost('quote_note',FILTER_DEFAULT);
