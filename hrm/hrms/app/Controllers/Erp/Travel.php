	...
	public function add_travel() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$visit_purpose = $this->request->getPost('visit_purpose',FILTER_DEFAULT);		
				$visit_place = $this->request->getPost('visit_place',FILTER_DEFAULT);
				$expected_budget = $this->request->getPost('expected_budget',FILTER_DEFAULT);
				$actual_budget = $this->request->getPost('actual_budget',FILTER_DEFAULT);	
				$arrangement_type = $this->request->getPost('arrangement_type',FILTER_DEFAULT);
				$travel_mode = $this->request->getPost('travel_mode',FILTER_DEFAULT);
