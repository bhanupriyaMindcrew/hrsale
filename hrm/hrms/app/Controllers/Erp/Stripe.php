...
class Stripe extends BaseController {
	...
	public function payment() 
	{
		...
		// get order info
		$token = udecode($this->request->getPost('token',FILTER_DEFAULT));
		$stripe_info = udecode($this->request->getPost('stripe_info',FILTER_DEFAULT));
		...
		$charge = \Stripe\Charge::create ([
                ...
                "source" => $this->request->getPost('stripeToken',FILTER_DEFAULT),
