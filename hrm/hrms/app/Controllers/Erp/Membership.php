...
class Membership extends BaseController {
	...
	public function add_membership() {
		...
		$price = $this->request->getPost('price',FILTER_DEFAULT);
		$plan_duration = $this->request->getPost('plan_duration',FILTER_DEFAULT);
		$total_employees = $this->request->getPost('total_employees',FILTER_DEFAULT);
