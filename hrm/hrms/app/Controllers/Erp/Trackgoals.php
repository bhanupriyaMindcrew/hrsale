...
class Trackgoals extends BaseController {
	...
	public function add_tracking() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$tracking_type = $this->request->getPost('tracking_type',FILTER_DEFAULT);
				$subject = $this->request->getPost('subject',FILTER_DEFAULT);
				$target_achiement = $this->request->getPost('target_achiement',FILTER_DEFAULT);
	...
	public function update_rating() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			if(!$this->validate($rules)){
				...
				$goal_rating = $this->request->getPost('goal_rating',FILTER_DEFAULT);
				$id = udecode($this->request->getPost('token',FILTER_DEFAULT));
				$data = [
	...
	public function add_work() {
		...
		if ($this->request->getPost('type') === 'edit_record') {
			...
			$goal_work = $this->request->getPost('goal_work',FILTER_DEFAULT);	
