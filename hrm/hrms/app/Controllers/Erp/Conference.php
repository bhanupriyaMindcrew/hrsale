	...
	public function add_meeting() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$conference_title = $this->request->getPost('conference_title',FILTER_DEFAULT);
				$conference_date = $this->request->getPost('conference_date',FILTER_DEFAULT);
				$conference_time = $this->request->getPost('conference_time',FILTER_DEFAULT);
				$conference_room = $this->request->getPost('conference_room',FILTER_DEFAULT);
				$conference_color = $this->request->getPost('conference_color',FILTER_DEFAULT);
				$conference_note = $this->request->getPost('conference_note',FILTER_DEFAULT);
				...
				if($user_info['user_type'] == 'staff'){
					...
					$assigned_ids = implode(',',$this->request->getPost('employee_id',FILTER_DEFAULT));
